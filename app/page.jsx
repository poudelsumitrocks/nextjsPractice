...
export default function Home() {
  return (
    ...
    >
      <div
        className="bg-white/20 backdrop-blur-lg border border-white/30 p-8 rounded-xl text-center shadow-lg transition-transform duration-300 ease-in-out hover:border-white hover: hover:shadow-2xl"
      >
        <h1 className="text-3xl font-semibold mb-4 text-white drop-shadow-lg">
          Welcome to page
        </h1>
